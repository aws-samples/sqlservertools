...
--DB Size
SELECT @UsedSpaceGB=round(sum((cast(size as bigint)*8))/1024/1024,2)
...
@isRMachineLearning as isRMachineLearning,@ISDQS as ISDQS, @ISPolicyBased  as ISPolicyBased , @isCLREnabled as isCLREnabled,@UsedSpaceGB as UsedSpaceGB,@isAOAG as IsAlwaysOnAG,@IsAOCluster as isalwaysonFCI,@isreadonly as IsReadReplica,@role_desc as DBRole,
@isfree as isfree ,case when @source is null then 'EC2/onPrem' else @source end as source
